      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="./xulydn.php" class="sign-in-form" method="post">
              <div class="logo">
           <div class="text1">
        <h2>COFFEE HOUSE</h2>
    </div>
        ...
        <filter id="fire">
            ...
            <feDisplacementMap in="SourceGraphic" scale="10"></feDisplacementMap>
              ...
              <div class="heading">
                ...
                <a href="./dangki.php" class="toggle">Sign up</a>
              </div>
              ...
              <div class="actual-form">
                ...
                <input type="submit" name="Sign In" value="Sign In" class="sign-btn" />
          ...
          <div class="container">
    <div class="plate"> 
      <img src="https://i.pinimg.com/564x/1b/2f/3b/1b2f3b6e76ce850312de20d045c019e2.jpg" alt="">
    </div>
<!-- <div class="cup">
    <div class="top">
        <div class="circle">
